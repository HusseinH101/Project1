...
scoreboard.py
--------------
Persistent scoreboard management for Pig Dice Game.

Functions:
    ensure_score_file(): Ensures the score file and folder exist.
    update_score(winner_name, players): Updates wins, losses, and total games.
    show_scores(): Prints the current high scores.
    rename_player(old_name, new_name): Rename or merge player stats.
    list_players(): Returns a list of all player names.
"""
